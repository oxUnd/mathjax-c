...
static const mjx_symbol_entry GREEK_LOWER[] = {
  ...
  {"epsilon",   0x03B5, MJX_TEXCLASS_ORD, 0},
  ...
  {"phi",       0x03C6, MJX_TEXCLASS_ORD, 0},
  {"varphi",    0x03D5, MJX_TEXCLASS_ORD, 0},
...
static const mjx_symbol_entry BIN_OPS[] = {
  ...
  {"smallsetminus", 0x2216, MJX_TEXCLASS_BIN, 0},
  {"smallsmile", 0x2323, MJX_TEXCLASS_BIN, 0},
  {"smallfrown", 0x2322, MJX_TEXCLASS_BIN, 0},
};
...
static const mjx_symbol_entry RELATIONS[] = {
  ...
  {"lvertneqq",  0x2268, MJX_TEXCLASS_REL, 0},
  {"gvertneqq",  0x2269, MJX_TEXCLASS_REL, 0},
  ...
  {"shortmid",   0x2223, MJX_TEXCLASS_REL, 0},
  {"shortparallel", 0x2225, MJX_TEXCLASS_REL, 0},
  {"nshortmid",  0x2224, MJX_TEXCLASS_REL, 0},
  {"nshortparallel", 0x2226, MJX_TEXCLASS_REL, 0},
  ...
  {"varsubsetneq", 0x228A, MJX_TEXCLASS_REL, 0},
  {"varsubsetneqq",0x2ACB, MJX_TEXCLASS_REL, 0},
  {"varsupsetneq", 0x228B, MJX_TEXCLASS_REL, 0},
  {"varsupsetneqq",0x2ACC, MJX_TEXCLASS_REL, 0},
  ...
  {"varpropto",  0x221D, MJX_TEXCLASS_REL, 0},
  {"circeq",     0x2257, MJX_TEXCLASS_REL, 0},
  {"thicksim",   0x223C, MJX_TEXCLASS_REL, 0},
...
static const mjx_symbol_entry MISC_SYMBOLS[] = {
  ...
  {"varnothing", 0x2205, MJX_TEXCLASS_ORD, 0},
  ...
  {"Bbbk",         0x210D, MJX_TEXCLASS_ORD, 0},
  ...
  {"diagdown",     0x2572, MJX_TEXCLASS_ORD, 0},
  {"diagup",       0x2571, MJX_TEXCLASS_ORD, 0},
